...
const (
	...
	INPUTMOTION       EventType = C.SDL_INPUTMOTION
	INPUTBUTTONDOWN   EventType = C.SDL_INPUTBUTTONDOWN
	INPUTBUTTONUP     EventType = C.SDL_INPUTBUTTONUP
	INPUTWHEEL        EventType = C.SDL_INPUTWHEEL
	INPUTPROXIMITYIN  EventType = C.SDL_INPUTPROXIMITYIN
	INPUTPROXIMITYOUT EventType = C.SDL_INPUTPROXIMITYOUT
	...
	TOUCHBUTTONDOWN EventType = C.SDL_TOUCHBUTTONDOWN
	TOUCHBUTTONUP   EventType = C.SDL_TOUCHBUTTONUP
...
func (ev *TouchButtonEvent) c() *C.SDL_TouchButtonEvent {
